...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=base_url()?>admin/Home" class="logo">
      ...
      <span class="logo-mini"><b>C</b>İ</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Cicek</b>k</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=base_url()?>uploads/<?=$veri[0]->resim?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 <?=$this->session->logged_in['ad']?>&nbsp<?=$this->session->logged_in['soyad']?> - <?=$veri[0]->durum?>
