...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Giriş</b>Yap</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Lütfen Email ve şifrenizi giriniz</p>
    ...
    <a href="register.html" class="text-center">Yeni Hesap</a>
	
	<?php if ($this->session->flashdata("login_hata"))
	{?>
	 <div class="callout callout-info">
                <h5>İşlem:  <?=$this->session->flashdata("login_hata")?></h5>
